                    ...
                    <div className="navbar-wrapper">
                            ...
                            <ul className="link-desktop link-desktop-center">
                                <li className="gbs">
                                    <ScrollLink
                                        ...
                                        offset={-70}
                                        duration={500}
                                        className={isNavLinkActive("hero") ? "active-link" : ""}
                                        data-replace="GBS"
                                ...
                                <li>
                                    <ScrollLink
                                        ...
                                        offset={-70}
                                        duration={500}
                                        className={isNavLinkActive("about-us") ? "active-link" : ""}
                                        data-replace="About"
                                ...
                                <li>
                                    <ScrollLink
                                        ...
                                        offset={-70}
                                        duration={500}
                                        className={isNavLinkActive("portfolio") ? "active-link" : ""}
                                ...
                                <li>
                                    <ScrollLink
                                        ...
                                        offset={-70}
                                        duration={500}
                                        className={isNavLinkActive("faqs") ? "active-link" : ""}
                                        data-replace="FAQs"
                                ...
                                <li>
                                    <ScrollLink
                                        ...
                                        offset={-70}
                                        duration={500}
                                        className={isNavLinkActive("contact") ? "active-link" : ""}
                        ...
                        <div className="navbar-mobile">
                            <div className="hamburger-wrap">
                                <div
                                    className="hamburger"
                                    data-toggle="modal-nav-mobile"
                                    onClick={() => (isMobileNavActive ? closeMobileNav() : openMobileNav())}
                                >
